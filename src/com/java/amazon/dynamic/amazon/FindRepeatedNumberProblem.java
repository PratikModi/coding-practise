...
public class FindRepeatedNumberProblem {
    ...
    public static int repeatedNumber(final List<Integer> A) {
        ...
        for (int i = 0; i <= n; i++)
        {
            ...
            // selected_block
            if ( ((selected_block * sq) < A.get(i)) &&
                    (A.get(i) <= ((selected_block + 1) * sq)))
            {
