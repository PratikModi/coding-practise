 ...
 */
public class UnderGroundSystemProblem {

    public static void main(String[] args) {
        UnderGroundSystemProblem undergroundSystem = new UnderGroundSystemProblem();
        undergroundSystem.checkIn(10, "Leyton", 3);
        undergroundSystem.checkOut(10, "Paradise", 8);
        var avgTime =undergroundSystem.getAverageTime("Leyton", "Paradise");
        System.out.println(avgTime);
        undergroundSystem.checkIn(5, "Leyton", 10);
        undergroundSystem.checkOut(5, "Paradise", 16);
        avgTime = undergroundSystem.getAverageTime("Leyton", "Paradise");
        System.out.println(avgTime);
        undergroundSystem.checkIn(2, "Leyton", 21);
    ...
    public UnderGroundSystemProblem() {
    ...
    public double getAverageTime(String startStation, String endStation) {
        return routeMap.get(startStation+","+endStation).averageTime();
    }
}
...
class Route{
    ...
    void addTrip(int checkInTime, int checkOutTime){
        totalTrips++;
        totalTripTime+=checkOutTime-checkInTime;
    }

    double averageTime(){
        return (double) totalTripTime/totalTrips;
    }
